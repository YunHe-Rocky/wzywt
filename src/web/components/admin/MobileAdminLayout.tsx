...
import { GLASS_CARD, GLASS_SHADOW_BOTTOM } from "@/web/animation";
  ...
  return (
    <div style={{ minHeight: "100dvh", background: "var(--bg-main)", color: "var(--text)" }}>
      ...
      <header style={{
        ...
        position: "sticky", top: 0, zIndex: "var(--layer-sticky)",
      }}>
      ...
      {/* Bottom Dock */}
      <div style={{
        position: "fixed", bottom: 0, left: 0, right: 0, zIndex: "var(--layer-dock)",
